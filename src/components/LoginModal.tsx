    ...
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl p-6 w-full max-w-md mx-auto">
        ...
        {isLoginView ? (
          <>
            <a
              href="https://accounts.google.com/o/oauth2/v2/auth?client_id=16847744847-qgtgslvsujpudjknvvtdhrrq8h881e4m.apps.googleusercontent.com&redirect_uri=https%3A%2F%2Fcardify.nodalforge.cloud%2Fmy-cards&response_type=code&scope=openid%20email%20profile"
              target="_top"
